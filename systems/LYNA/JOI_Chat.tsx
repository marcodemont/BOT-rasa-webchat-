...
import { Send, X, Minimize2, Maximize2, MessageCircle, Loader2 } from 'lucide-react';
...
export function JOIBubbleChat({ onClose, userId }: JOIBubbleChatProps) {
  ...
  return (
    <motion.div
      ...
      className="w-96 bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200"
    >
      {/* Header */}
